...
export const PROCESS_TEMPLATES: ProcessTemplate[] = [
  ...
  },
  {
    id: "cell-therapy",
    name: "Cell Therapy",
    modality: "Patient-specific or allogeneic therapy workflows with high chain-of-identity, release, and scheduling sensitivity.",
    summary:
      "Best for teams where orchestration, sample burden, operator guidance, and release coordination are as important as core bioprocess control.",
    stageLabel: "Patient-sensitive operations",
    scaleProfiles: [
      {
        id: "development",
        label: "Process Development",
        summary: "Focus is on process understanding, comparability, and operating windows.",
        complexityBias: 0.98,
      },
      {
        id: "clinical",
        label: "Clinical Operations",
        summary: "Scheduling, chain-of-identity, and documentation are inseparable from performance.",
        complexityBias: 1.05,
      },
      {
        id: "commercial",
        label: "Commercial Operations",
        summary: "Operational discipline and release orchestration dominate value.",
        complexityBias: 1.14,
      },
    ],
    base: {
      manualHoursPerRun: 34,
      dataLatencyHours: 22,
      runSuccessRate: 85,
      yieldStability: 76,
      transferReadiness: 66,
      qualityReadiness: 70,
      transferPackageHours: 96,
    },
    coreOutcomes: [
      "Reduce operator-dependent execution variance",
      "Improve evidence quality for batch disposition",
      "Shorten turnaround between execution, analytics, and release decisions",
    ],
    instruments: [
      {
        name: "Cell culture systems and controlled incubation platforms",
        role: "Run activation, expansion, and conditioning steps.",
        category: "Bioreactors",
        impact: "Forms the physical backbone of the therapy workflow.",
      },
      {
        name: "Environmental, temperature, gas, and process sensors",
        role: "Track basic operating conditions and excursions.",
        category: "Core Sensors",
        impact: "Supports stability and exception detection.",
      },
      {
        name: "Viability, biomass, and in-process PAT proxies",
        role: "Increase process visibility without excessive manual intervention.",
        category: "PAT",
        impact: "Improves timing and consistency in sensitive workflows.",
      },
      {
        name: "Flow cytometry, cell counters, bioanalyzers, potency assays",
        role: "Provide product and process evidence for release and disposition.",
        category: "At-Line / Off-Line Analyzers",
        impact: "Often the pacing step for decision readiness.",
      },
      {
        name: "Cryopreservation, formulation, and final product systems",
        role: "Support final material handling and release preparation.",
        category: "Downstream Equipment",
        impact: "Determines final product readiness and handling risk.",
      },
      {
        name: "MES, scheduling orchestration, chain-of-identity, batch review systems",
        role: "Keep the digital thread intact across patient-sensitive steps.",
        category: "Digital Systems",
        impact: "Large value driver where operations remain manual.",
      },
    ],
    unitOperations: [
      {
        id: "activation",
        name: "Activation and Early Processing",
        objective: "Start the patient or donor material workflow with tight control and traceability.",
        criticalSignals: ["Timing", "cell state", "identity context"],
        likelyInstruments: ["Culture system", "Environmental sensors", "Cell counter"],
        sensitivity: {
          sensors: 0.8,
          pat: 0.7,
          analyzers: 0.9,
      ...
      {
        id: "expansion-cell-therapy",
        name: "Expansion and Conditioning",
        objective: "Keep a repeatable operating state despite sensitive biological variation.",
        criticalSignals: ["Growth", "viability", "media condition", "schedule adherence"],
        likelyInstruments: ["Bioreactor", "PAT", "At-line analyzers"],
        sensitivity: {
          sensors: 1,
          pat: 1,
          analyzers: 1,
      ...
      {
        id: "harvest-formulation-cell-therapy",
        name: "Harvest, Formulation, and Product Handling",
        objective: "Protect product quality and chain-of-identity through final handling steps.",
        criticalSignals: ["Handling timing", "hold conditions", "identity continuity"],
        likelyInstruments: ["Formulation systems", "Environmental tracking", "Digital chain-of-identity"],
        sensitivity: {
          sensors: 0.7,
          pat: 0.4,
          analyzers: 0.8,
      ...
      {
        id: "release-cell-therapy",
        name: "Release Coordination and Disposition",
        objective: "Connect operational evidence, analytics, and release decisions quickly.",
        criticalSignals: ["Turnaround time", "exception review", "release evidence quality"],
        likelyInstruments: ["QC systems", "Scheduling layer", "Batch review workspace"],
        sensitivity: {
          sensors: 0.2,
          pat: 0.2,
          analyzers: 1.1,
